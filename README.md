# [CSON](https://github.com/bevry/cson) Plugin for DocPad

<!-- BADGES/ -->

[![Build Status](http://img.shields.io/travis-ci/docpad/docpad-plugin-cson.png?branch=master)](http://travis-ci.org/docpad/docpad-plugin-cson "Check this project's build status on TravisCI")
[![NPM version](http://badge.fury.io/js/docpad-plugin-cson.png)](https://npmjs.org/package/docpad-plugin-cson "View this project on NPM")
[![Dependency Status](https://david-dm.org/docpad/docpad-plugin-cson.png?theme=shields.io)](https://david-dm.org/docpad/docpad-plugin-cson)
[![Development Dependency Status](https://david-dm.org/docpad/docpad-plugin-cson/dev-status.png?theme=shields.io)](https://david-dm.org/docpad/docpad-plugin-cson#info=devDependencies)<br/>
